...
[@justaname.id/sdk](../globals.md) / RequestAppendMAppFieldChallengeRoute

# Interface: RequestAppendMAppFieldChallengeRoute

## Extends

- [`IRoute`](IRoute.md)\<[`RequestAppendMAppFieldChallengeRequest`](RequestAppendMAppFieldChallengeRequest.md), [`RequestAppendMAppFieldChallengeResponse`](RequestAppendMAppFieldChallengeResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`RequestAppendMAppFieldChallengeRequest`](RequestAppendMAppFieldChallengeRequest.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>, `never`\>
...
> **request**: [`RequestAppendMAppFieldChallengeRequest`](RequestAppendMAppFieldChallengeRequest.md)
...
> **response**: [`RequestAppendMAppFieldChallengeResponse`](RequestAppendMAppFieldChallengeResponse.md)
