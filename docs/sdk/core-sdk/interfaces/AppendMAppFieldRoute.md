...
[@justaname.id/sdk](../globals.md) / AppendMAppFieldRoute

# Interface: AppendMAppFieldRoute

## Extends

- [`IRoute`](IRoute.md)\<[`AppendMAppFieldRequest`](AppendMAppFieldRequest.md), [`SubnameResponse`](SubnameResponse.md), [`SIWEHeaders`](SIWEHeaders.md)\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`AppendMAppFieldRequest`](AppendMAppFieldRequest.md), `never`\>, `never`\>
...
> **request**: [`AppendMAppFieldRequest`](AppendMAppFieldRequest.md)
