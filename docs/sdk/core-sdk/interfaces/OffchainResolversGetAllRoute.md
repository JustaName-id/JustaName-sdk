...
[@justaname.id/sdk](../globals.md) / OffchainResolversGetAllRoute

# Interface: OffchainResolversGetAllRoute

## Extends

- [`IRoute`](IRoute.md)\<[`OffchainResolverGetAllRequest`](OffchainResolverGetAllRequest.md), [`OffchainResolverGetAllResponse`](OffchainResolverGetAllResponse.md), [`EmptyHeaders`](EmptyHeaders.md)\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`OffchainResolverGetAllRequest`](OffchainResolverGetAllRequest.md), `never`\>, `never`\>
...
> **request**: [`OffchainResolverGetAllRequest`](OffchainResolverGetAllRequest.md)
...
> **response**: [`OffchainResolverGetAllResponse`](OffchainResolverGetAllResponse.md)
