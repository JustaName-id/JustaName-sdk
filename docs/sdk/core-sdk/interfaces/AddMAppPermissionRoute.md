...
[@justaname.id/sdk](../globals.md) / AddMAppPermissionRoute

# Interface: AddMAppPermissionRoute

## Extends

- [`IRoute`](IRoute.md)\<[`AddMAppPermissionRequest`](AddMAppPermissionRequest.md), [`SubnameResponse`](SubnameResponse.md)\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`AddMAppPermissionRequest`](AddMAppPermissionRequest.md), `never`\>, `never`\>
...
> **request**: [`AddMAppPermissionRequest`](AddMAppPermissionRequest.md)
