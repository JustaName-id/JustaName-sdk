...
[@justaname.id/sdk](../globals.md) / SubnameGetAllByEnsDomainWithCountRoute

# Interface: SubnameGetAllByEnsDomainWithCountRoute

## Extends

- [`IRoute`](IRoute.md)\<[`SubnameGetAllByEnsDomainWithCountRequest`](SubnameGetAllByEnsDomainWithCountRequest.md), [`SubnameGetAllByEnsDomainWithCountResponse`](SubnameGetAllByEnsDomainWithCountResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"chainId"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`SubnameGetAllByEnsDomainWithCountRequest`](SubnameGetAllByEnsDomainWithCountRequest.md), `"chainId"`\>, `never`\>
...
> **request**: [`SubnameGetAllByEnsDomainWithCountRequest`](SubnameGetAllByEnsDomainWithCountRequest.md)
...
> **response**: [`SubnameGetAllByEnsDomainWithCountResponse`](SubnameGetAllByEnsDomainWithCountResponse.md)
