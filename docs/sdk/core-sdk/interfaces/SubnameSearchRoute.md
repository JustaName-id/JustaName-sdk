...
[@justaname.id/sdk](../globals.md) / SubnameSearchRoute

# Interface: SubnameSearchRoute

## Extends

- [`IRoute`](IRoute.md)\<[`SubnameSearchRequest`](SubnameSearchRequest.md), [`SubnameSearchResponse`](SubnameSearchResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"chainId"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`SubnameSearchRequest`](SubnameSearchRequest.md), `"chainId"`\>, `never`\>
