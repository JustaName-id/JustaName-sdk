...
[@justaname.id/sdk](../globals.md) / IsSubnameAvailableRoute

# Interface: IsSubnameAvailableRoute

## Extends

- [`IRoute`](IRoute.md)\<[`IsSubnameAvailableRequest`](IsSubnameAvailableRequest.md), [`IsSubnameAvailableResponse`](IsSubnameAvailableResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"chainId"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`IsSubnameAvailableRequest`](IsSubnameAvailableRequest.md), `"chainId"`\>, `never`\>
