...
[@justaname.id/sdk](../globals.md) / RequestRevokeMAppPermissionChallengeRoute

# Interface: RequestRevokeMAppPermissionChallengeRoute

## Extends

- [`IRoute`](IRoute.md)\<[`RequestRevokeMAppPermissionChallengeRequest`](RequestRevokeMAppPermissionChallengeRequest.md), [`RequestRevokeMAppPermissionChallengeResponse`](RequestRevokeMAppPermissionChallengeResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`RequestRevokeMAppPermissionChallengeRequest`](RequestRevokeMAppPermissionChallengeRequest.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>, `never`\>
...
> **request**: [`RequestRevokeMAppPermissionChallengeRequest`](RequestRevokeMAppPermissionChallengeRequest.md)
...
> **response**: [`RequestRevokeMAppPermissionChallengeResponse`](RequestRevokeMAppPermissionChallengeResponse.md)
