...
[@justaname.id/sdk](../globals.md) / SubnameGetAllByDomainChainIdRoute

# Interface: SubnameGetAllByDomainChainIdRoute

## Extends

- [`IRoute`](IRoute.md)\<[`SubnameGetAllByDomainChainIdRequest`](SubnameGetAllByDomainChainIdRequest.md), [`SubnameGetAllByDomainChainIdResponse`](SubnameGetAllByDomainChainIdResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"chainId"` \| `"ensDomain"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`SubnameGetAllByDomainChainIdRequest`](SubnameGetAllByDomainChainIdRequest.md), `"chainId"` \| `"ensDomain"`\>, `never`\>
