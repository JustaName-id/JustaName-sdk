...
[@justaname.id/sdk](../globals.md) / SubnameGetAllByAddressRoute

# Interface: SubnameGetAllByAddressRoute

## Extends

- [`IRoute`](IRoute.md)\<[`SubnameGetAllByAddressRequest`](SubnameGetAllByAddressRequest.md), [`SubnameGetAllByAddressResponse`](SubnameGetAllByAddressResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"chainId"` \| `"coinType"` \| `"isClaimed"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`SubnameGetAllByAddressRequest`](SubnameGetAllByAddressRequest.md), `"coinType"` \| `"chainId"` \| `"isClaimed"`\>, `never`\>
