...
[@justaname.id/sdk](../globals.md) / SubnameRejectRoute

# Interface: SubnameRejectRoute

## Extends

- [`IRoute`](IRoute.md)\<[`SubnameRejectRequest`](SubnameRejectRequest.md), [`SubnameResponse`](SubnameResponse.md), [`SIWEHeaders`](SIWEHeaders.md), `"ensDomain"` \| `"chainId"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`SubnameRejectRequest`](SubnameRejectRequest.md), `"chainId"` \| `"ensDomain"`\>, `never`\>
