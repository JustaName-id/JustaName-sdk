...
[@justaname.id/sdk](../globals.md) / SubnameRecordsRoute

# Interface: SubnameRecordsRoute

## Extends

- [`IRoute`](IRoute.md)\<[`SubnameRecordsRequest`](SubnameRecordsRequest.md), [`SubnameResponse`](SubnameResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"providerUrl"`, `never`, `object`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`SubnameRecordsRequest`](SubnameRecordsRequest.md), `"providerUrl"`\>, `never`\> & `object`
