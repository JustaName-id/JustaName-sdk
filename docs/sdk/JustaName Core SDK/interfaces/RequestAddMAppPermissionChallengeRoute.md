...
[@justaname.id/sdk](../globals.md) / RequestAddMAppPermissionChallengeRoute

# Interface: RequestAddMAppPermissionChallengeRoute

## Extends

- [`IRoute`](IRoute.md)\<[`RequestAddMAppPermissionChallengeRequest`](RequestAddMAppPermissionChallengeRequest.md), [`RequestAddMAppPermissionChallengeResponse`](RequestAddMAppPermissionChallengeResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`RequestAddMAppPermissionChallengeRequest`](RequestAddMAppPermissionChallengeRequest.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>, `never`\>
...
> **request**: [`RequestAddMAppPermissionChallengeRequest`](RequestAddMAppPermissionChallengeRequest.md)
...
> **response**: [`RequestAddMAppPermissionChallengeResponse`](RequestAddMAppPermissionChallengeResponse.md)
