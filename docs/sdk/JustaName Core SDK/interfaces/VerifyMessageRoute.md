...
[@justaname.id/sdk](../globals.md) / VerifyMessageRoute

# Interface: VerifyMessageRoute

## Extends

- [`IRoute`](IRoute.md)\<[`VerifyChallengeRequest`](VerifyChallengeRequest.md), [`VerifyChallengeResponse`](VerifyChallengeResponse.md), [`EmptyHeaders`](EmptyHeaders.md)\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`VerifyChallengeRequest`](VerifyChallengeRequest.md), `never`\>, `never`\>
