...
[@justaname.id/sdk](../globals.md) / RequestChallengeRoute

# Interface: RequestChallengeRoute

## Extends

- [`IRoute`](IRoute.md)\<[`RequestChallengeRequest`](RequestChallengeRequest.md), [`RequestChallengeResponse`](RequestChallengeResponse.md), [`EmptyHeaders`](EmptyHeaders.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>
...
> **params**: `Omit`\<[`MakeOptionalProps`](../type-aliases/MakeOptionalProps.md)\<[`RequestChallengeRequest`](RequestChallengeRequest.md), `"origin"` \| `"domain"` \| `"chainId"` \| `"ttl"`\>, `never`\>
