...
import { JustaNameDialog, JustSignInContext, useSignInWithJustaName } from '@justaname.id/react-signin';
import {
  Badge,
  Button,
  Flex,
...
export const EmailDialog: FC<EmailDialogProps> = ({
  ...
  const { updateRecords } = useSignInWithJustaName()
            ...
            <Button
              ...
              onClick={() => {
                ...
                verifyOtp({
                  ...
                  const key = 'email';
                  const vc = res.verifiedCredential
