...
export default function ThetaLegacy(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <defs>
        ...
        <linearGradient
          xlinkHref="#thetaLegacy_svg__a"
          id="thetaLegacy_svg__b"
          x1={175.55}
          x2={258.18}
          y1={175.91}
          y2={258.54}
      ...
      <path
        fill="#1b1f2b"
        stroke="url(#thetaLegacy_svg__a)"
        strokeLinejoin="bevel"
        strokeWidth={27.222}
        d="M145.06 93.1h142.89v246.81H145.06z"
      />
      <path
        fill="url(#thetaLegacy_svg__b)"
