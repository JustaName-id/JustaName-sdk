...
const StyledInputOTPSlot = styled.div<{ isActive: boolean }>`
  ...
  align-items: center;
  justify-content: center;
  border-top: 1px solid var(--justaname-foreground-color-4);
  border-right: 1px solid var(--justaname-foreground-color-4);;
  border-bottom: 1px solid var(--justaname-foreground-color-4);;
  font-size: 1.25rem; /* text-lg */
  transition: all 0.2s;

  &:first-child {
    border-left: 1px solid var(--justaname-foreground-color-4);
  ...
  css`
      z-index: 10;
      box-shadow: 0 0 0 2px var(--justaname-primary-color);
    `}
`;
