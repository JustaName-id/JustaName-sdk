...
export interface RequestAddMAppPermissionChallengeRoute extends IRoute<RequestAddMAppPermissionChallengeRequest, RequestAddMAppPermissionChallengeResponse, EmptyHeaders, 'origin' | 'domain' | 'chainId' | 'ttl'> {}