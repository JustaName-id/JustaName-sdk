...
/**
 * Defines the request structure for claiming a subname.
 *
 * @interface SubnameClaimRequest
 * @extends IRequest
 * @public
...
/**
 * Outlines the response received upon successfully claiming a subname.
 *
 * @interface SubnameClaimResponse
 * @extends IResponse
 * @public
...
/**
 * Configures the route for claiming a subname.
 *
 * @interface SubnameClaimRoute
 * @extends IRoute
 * @public
 * @property {SubnameClaimRequest} request - The data structure for the claim request.
 * @property {SubnameClaimResponse} response - The expected structure for the claim response.
