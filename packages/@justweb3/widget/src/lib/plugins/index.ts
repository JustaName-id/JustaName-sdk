...
type OnWalletConnectedHook = (pluginApi: PluginApi, address: string, chainId: number) => void;
type OnWalletDisconnectedHook = (pluginApi: PluginApi, address: string) => void;
type OnWalletChangedHook = (pluginApi: PluginApi, address: string, chainId: number) => void;
type OnEnsSignInHook = (pluginApi: PluginApi, ens: string, chainId: number, records: UseRecordsResult['records'], enabledMApps: string[], canEnableMApps: boolean) => void;
type OnEnsChangeHook = (pluginApi: PluginApi, ens: string, records: UseRecordsResult['records'], enabledMApps: string[], canEnableMApps: boolean) => void;
...
type OnMAppRemoveHook = (pluginApi: PluginApi, ens: string, mApp: string) => void;
type OnRecordsChangeHook = (pluginApi: PluginApi, ens: string, records: UseRecordsResult['records'], enabledMApps: string[], canEnableMApps: boolean) => void;
type OnSubnameClaimedHook = (pluginApi: PluginApi, subname: string) => void;
type OnSwitchChain = (pluginApi: PluginApi, fromChain: number, toChain: number) => void
...
interface Hooks {
  ...
  onStateChange?: (pluginApi: PluginApi, pluginName: string, key: string, value: any) => void;
}
