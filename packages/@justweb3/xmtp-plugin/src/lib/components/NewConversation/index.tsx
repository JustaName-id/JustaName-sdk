...
import { ArrowIcon, CloseIcon, Flex, Input, LoadingSpinner, P, VerificationsIcon } from '@justweb3/ui';
...
const NewConversation: React.FC<NewConversationProps> = ({
    ...
    const isAddressName = useMemo(() => {
        ...
        return (
            !ethAddressRegex.test(debouncedAddress) &&
                    ...
                    left={
                        <Flex direction='row' gap='5px'>
                            ...
                            {isSearchLoading ? (
                                ...
                                debouncedAddress.length > 0 ?
                                    <VerificationsIcon
                                        fill={canMessage ? '#00c311' : 'var(--justweb3-destructive-color)'}
                                        width={20} height={20} />
                                    : null
                            )}
                        </Flex>
