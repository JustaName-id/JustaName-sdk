...
const InputWrapper = styled.div<InputWrapperProps>`
    ...
    align-items: center;
    border-radius: 16px;
    border: 1px solid ${props => props.$error ? 'var(--justweb3-destructive-color)' : '#E5E5E5'};
    ...
    &:focus-within {
        outline: none;
        border-color: ${props => props.$error ? 'var(--input-error-border-color)' : 'var(--justweb3-primary-color)'};
    }
`;
