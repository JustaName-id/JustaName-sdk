...
export default function Srm(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path
        d="M125.5 233.9c-43.1 0-78.1-35-78.1-78.1 0-41.9 70.7-115.9 73.7-119l3.7-3.9 3.8 3.8c3.1 3.1 75 77.1 75 119 0 43.2-35 78.2-78.1 78.2M124.9 48c-6.2 6.7-19.2 21.2-32.1 38.2-22.9 30.2-35 54.2-35 69.5 0 37.3 30.4 67.7 67.7 67.7s67.7-30.4 67.7-67.7c0-15.3-12.3-39.3-35.6-69.5-13.1-16.9-26.4-31.5-32.7-38.2"
        style={{
          fill: 'url(#srm_svg__a)',
        }}
      />
