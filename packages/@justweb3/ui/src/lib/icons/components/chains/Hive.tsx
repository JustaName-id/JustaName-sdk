...
export default function Hive(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 190" {...props}>
      <defs>
        <style>{'.hive_svg__cls-1{fill:#e31337}'}</style>
      </defs>
      <g id="hive_svg__Layer_2" data-name="Layer 2">
        <g id="hive_svg__Layer_1-2" data-name="Layer 1">
          <path
