...
const ThemeChange = () => {
  ...
  const [backgroundHsva, setBackgroundHsva] = React.useState({ h: 0, s: 0, v: 0, a: 1 });
  return (
    <div style={{ display: 'flex', justifyContent: 'center', gap: '5px' }}>
      ...
      <div style={{
        ...
        }} onClick={() => changeTheme('background', '#ffffff')}></button>
        ...
        <button style={{
          ...
          cursor: 'pointer',
          border: '1px solid hsl(0,0%,92%)'
        }} onClick={() => changeTheme('background', '#000000')}></button>
      ...
      <div style={{
        ...
        <button style={{
          ...
          cursor: 'pointer',
          border: '1px solid hsl(0,0%,92%)'
        }} onClick={() => changeTheme('primary', 'var(--justweb3-primary-color)')}></button>
        ...
        <button style={{
          ...
          cursor: 'pointer',
          border: '1px solid hsl(0,0%,92%)'
        }} onClick={() => changeTheme('primary', '#000000')}></button>
    ...
    <>
      ...
      >
        ...
        <Flex
          ...
          gap={'10px'}
        >
          <ClickableItem name={'mysubname.justan.id'} status={'Verified'} />
          <ClickableItem name={'mysubname.justan.id'} />
        </Flex>
        <OrLine />
